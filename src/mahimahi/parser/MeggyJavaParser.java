...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Oct 01 11:47:35 EDT 2015
  */
public class MeggyJavaParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\002\005\016\000\002\007\006\000\002\007\003\000\002" +
    "\007\003\000\002\006\002" });
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\056\000\004\060\005\001\002\000\004\002\060\001" +
    ...
    "\004\020\027\001\002\000\006\021\ufff4\062\033\001\002" +
    "\000\004\021\ufffc\001\002\000\006\021\ufff4\062\033\001" +
    "\002\000\004\021\055\001\002\000\004\016\034\001\002" +
    "\000\010\016\040\051\036\052\035\001\002\000\006\014" +
    "\ufff5\017\ufff5\001\002\000\006\014\ufff6\017\ufff6\001\002" +
    "\000\004\014\ufffb\001\002\000\004\027\041\001\002\000" +
    "\004\017\042\001\002\000\010\016\040\051\036\052\035" +
    "\001\002\000\006\014\ufff7\017\ufff7\001\002\000\004\014" +
    "\045\001\002\000\010\016\040\051\036\052\035\001\002" +
    "\000\004\014\ufffa\001\002\000\004\014\050\001\002\000" +
    "\010\016\040\051\036\052\035\001\002\000\004\017\ufff9" +
    "\001\002\000\004\017\053\001\002\000\004\024\054\001" +
    "\002\000\006\021\ufff8\062\ufff8\001\002\000\004\021\056" +
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\031\005\030\006\027\001\001\000\002\001\001\000\010" +
    "\004\056\005\030\006\027\001\001\000\002\001\001\000" +
    ...
    "\004\012\046\001\001\000\002\001\001\000\004\007\050" +
...
class CUP$MeggyJavaParser$actions {
      ...
      switch (CUP$MeggyJavaParser$act_num)
        {
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 12: // Expression ::= COLOR_LITERAL 
            {
		...
		SymbolValue e = (SymbolValue)((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.peek()).value;
		 RESULT = e;  
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 11: // Expression ::= INT_LITERAL 
            {
              SymbolValue RESULT =null;
		int eleft = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()).left;
		int eright = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()).right;
		SymbolValue e = (SymbolValue)((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.peek()).value;
		 RESULT = e; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 10: // Expression ::= LPAREN BYTE RPAREN Expression 
            {
              SymbolValue RESULT =null;
		int eleft = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()).left;
		int eright = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()).right;
		SymbolValue e = (SymbolValue)((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.peek()).value;
		 RESULT = e; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 9: // Statement ::= MEGGYSETPIXEL LPAREN Expression NT$1 COMMA Expression NT$2 COMMA Expression NT$3 RPAREN SEMI 
            {
              Object RESULT =null;
              // propagate RESULT from NT$3
                RESULT = (Object) ((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-2)).value;
		int e0left = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-9)).left;
		int e0right = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-9)).right;
		SymbolValue e0 = (SymbolValue)((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-9)).value;
		int e1left = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-6)).left;
		int e1right = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-6)).right;
		SymbolValue e1 = (SymbolValue)((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-6)).value;
		int e2left = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-3)).left;
		int e2right = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-3)).right;
		SymbolValue e2 = (SymbolValue)((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-3)).value;
 ...
 parser.out.println("call _Z12DisplaySlatev");
              ...
              CUP$MeggyJavaParser$result = parser.getSymbolFactory().newSymbol("Statement",3, ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-11)), ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()), RESULT);
            }
          return CUP$MeggyJavaParser$result;
          ...
          case 8: // NT$3 ::= 
            {
              Object RESULT =(Object) ((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-2)).value;
		...
		int e1left = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-3)).left;
		int e1right = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-3)).right;
		SymbolValue e1 = (SymbolValue)((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-3)).value;
		int e2left = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()).left;
		int e2right = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()).right;
		SymbolValue e2 = (SymbolValue)((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.peek()).value;
  parser.out.println("ldi r20, lo8("+e2.lexeme+")"); 
              CUP$MeggyJavaParser$result = parser.getSymbolFactory().newSymbol("NT$3",9, ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()), RESULT);
            }
          return CUP$MeggyJavaParser$result;
          ...
          case 7: // NT$2 ::= 
            {
              Object RESULT =(Object) ((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-2)).value;
		int e0left = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-3)).left;
		int e0right = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-3)).right;
		SymbolValue e0 = (SymbolValue)((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.elementAt(CUP$MeggyJavaParser$top-3)).value;
		int e1left = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()).left;
		int e1right = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()).right;
		SymbolValue e1 = (SymbolValue)((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.peek()).value;
  parser.out.println("ldi r22, lo8("+e1.lexeme+")"); 
              CUP$MeggyJavaParser$result = parser.getSymbolFactory().newSymbol("NT$2",8, ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()), RESULT);
            }
          return CUP$MeggyJavaParser$result;
          ...
          case 6: // NT$1 ::= 
            {
              Object RESULT =null;
		int e0left = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()).left;
		int e0right = ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()).right;
		SymbolValue e0 = (SymbolValue)((java_cup.runtime.Symbol) CUP$MeggyJavaParser$stack.peek()).value;
  parser.out.println("ldi r24, lo8("+e0.lexeme+")"); 
              CUP$MeggyJavaParser$result = parser.getSymbolFactory().newSymbol("NT$1",7, ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$MeggyJavaParser$stack.peek()), RESULT);
            }
          return CUP$MeggyJavaParser$result;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // MainClass ::= CLASS IDENTIFIER NT$0 LBRACE PUBLIC STATIC VOID MAIN LPAREN STRING_TYPE LBRACKET RBRACKET IDENTIFIER RPAREN LBRACE Statement_list RBRACE RBRACE 
            {
              Object RESULT =null;
